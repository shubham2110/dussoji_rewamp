            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success mx-auto" id="support_submit" onclick="">Submit</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <main>
                ...
                <div class="container">
                    <div class="text-center mb-5">
                        <div class="display-4 text-primary mb-2">Watch Live webinars</div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- Create Organization-->
                            <div class="col-xxl-8 col-lg-8 mb-4 mx-auto">
                                <div class="card text-center h-100">
                                    <div class="card-body px-5 pt-5 d-flex flex-column">

                                    </div>
                                    <div class="card-footer bg-transparent px-5 py-4">
                                        <div class="small text-center"><a class="btn btn-block btn-primary">Join Webinar</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
